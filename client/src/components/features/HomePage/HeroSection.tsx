        ...
        <section className="hero-section">
            <div className="container mx-auto">
                <div className="flex py-12 flex-col lg:flex-row justify-center">
                    ...
                    <div className="w-full lg:w-2/3 p-5 py-20  text-center flex flex-col gap-8 justify-center animate-in fade-in slide-in-from-bottom-8 duration-700">
                        <div className="flex flex-col gap-6">
                            <h1 className="text-5xl lg:text-7xl font-extrabold tracking-tight text-gradient pb-2">
                                Pooja Beauty Makeover <br /> & Classes
                            </h1>
                            <p className="text-lg md:text-xl text-muted-foreground leading-relaxed">
                                Welcome to Pooja Beauty Makeover, where we believe every woman deserves to feel confident and beautiful. Experience premium services in a warm, welcoming environment.
                            </p>
                        </div>
                        <div className="flex justify-center gap-4 flex-col md:flex-row">
                            <Link to="/appointments">
                                <Button size="lg" className="rounded-full shadow-lg hover:shadow-xl transition-all h-14 px-8 text-lg cursor-pointer w-full">
                                    Book Appointment
